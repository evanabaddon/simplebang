                              ...
                              <div class="p-5">
                                  <div class="grid grid-cols-12 gap-5">
                                      <div class="col-span-12 xl:col-span-4">
                                          <div class="border border-gray-200 rounded-md p-5">
                                              <div class="w-40 h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                                  <img class="rounded-md" width="200" id="preview" alt="Midone Tailwind HTML Admin Template" src="/dist/images/profile-11.jpg">
                                      ...
                                      <div class="col-span-12 xl:col-span-8">
                                          <div class="mt-3">
                                              <label>Nama</label>
                                              <input type="text" name="nama" class="input w-full border bg-gray-100  mt-2"  placeholder="Nama Perusahaan">
                                          </div>
                                          <div class="mt-3">
                                          ...
                                          <div class="mt-3">
                                              <label>Alamat</label>
                                              <textarea name="alamat" rows="4" class="input w-full border bg-gray-100  mt-2" placeholder="Alamat Perusahaan"></textarea>
                                          </div>
                                          <div class="mt-3">
                                              <label>Email</label>
                                              <input type="email" name="email" class="input w-full border bg-gray-100  mt-2"  placeholder="Email Perusahaan">
                                          </div>
                                          <div class="mt-3">
                                              <label>Telepon</label>
                                              <input type="text" name="no_telepon" class="input w-full border bg-gray-100  mt-2"  placeholder="Telepon Perusahaan">
                                          </div>
                            ...
                            <div class="p-5">
                                <div class="grid grid-cols-12 ">
                                    ...
                                    <div class="col-span-12 xl:col-span-12">
                                        <div class="mt-3">
                                            <label>Nama</label>
                                            <input type="text" name="nama_pemilik" class="input w-full border bg-gray-100  mt-2"  placeholder="Nama Pemilik Perusahaan">
                                        </div>
                                        <div class="mt-3">
                                            <label>Alamat</label>
                                            <textarea name="alamat_pemilik" rows="4" class="input w-full border bg-gray-100  mt-2" placeholder="Alamat Pemilik Perusahaan"></textarea>
                                        </div>
                                        <div class="mt-3">
                                            <label>Email</label>
                                            <input type="email" name="email_pemilik" class="input w-full border bg-gray-100  mt-2"  placeholder="Email Pemilik Perusahaan">
                                        </div>
                                        <div class="mt-3">
                                            <label>Telepon</label>
                                            <input type="text" name="telepon_pemilik" class="input w-full border bg-gray-100  mt-2"  placeholder="Telepon Pemilik Perusahaan">
                                        </div>
