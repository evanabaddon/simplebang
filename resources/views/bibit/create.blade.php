                ...
                <div class="grid grid-cols-12">
                    ...
                    <div class="col-span-12 lg:col-span-8 xxl:col-span-9">
                        ...
                        <div class="intro-y box lg:mt-5">
                            ...
                            <form class="" action="{{ route('bibit.store') }}" method="post" enctype="multipart/form-data">
                              @csrf
                              <div class="p-5">
                                  <div class="grid grid-cols-12 gap-5">
                                      ...
                                      <div class="col-span-12 xl:col-span-8">
                                          <div>
                                              <label>Jenis</label>
                                              <input type="text" name="jenis" class="input w-full border bg-gray-100  mt-2"  placeholder="Misal: Alpukat,Nangka">
                                          </div>
                                          <div>
                                            <label>Harga</label>
