...
<!-- BEGIN: Content -->
               ...
               @endif
                ...
                <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-6">
                        <input type="text" name="judul" id="judul" class="intro-y input input--lg w-full box pr-10 placeholder-theme-13" placeholder="Judul Penanaman">
                                        ...
                                        <div class="mt-5">
                                          <div class="mt-3">
                                              ...
                                              <select class="input w-full border bg-gray-100  mt-2" id="tambang" name="tambang_id">
                                                <option value="0"> Pilih Tambang </option>
                                          ...
                                          <div class="mt-3">
                                              ...
                                              <input type="text" name="luas" class="input w-full border  mt-2" id="luas" placeholder="1000 m2">
                                          </div>
                    ...
                    <div class="col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box p-5">
                            <div class="mt-3">
                                ...
                                <input type="date" class="input w-full border bg-white-100  mt-2" name="tanggal" id="tanggal">
                            </div>
                            <div class="mt-3">
            ...
            <!-- END: Content -->
            <form class="hidden" id="form-penanaman" action="{{ route('penanaman.store') }}" method="post" enctype="multipart/form-data">
                @csrf
            </form>
@endsection
@section('js')
