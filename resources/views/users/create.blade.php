                              ...
                              <div class="p-5">
                                  <div class="grid grid-cols-12 gap-5">
                                      ...
                                      <div class="col-span-12 xl:col-span-9">
                                          <div class="mt-3">
                                              <label>NIK</label>
                                              <input type="text" name="nik" class="input w-full border  mt-2"  placeholder="16 Digit NIK">
                                          </div>
                                          <div class="mt-3">
                                              <label>NAMA</label>
                                              <input type="text" name="nama" class="input w-full border  mt-2"  placeholder="Nama">
                                          </div>
                                          <div class="mt-3">
                                              <label>ALAMAT</label>
