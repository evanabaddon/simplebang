...
<!-- BEGIN: Content -->
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="/" class="">Dashboard</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="{{ route('penggunaan-donasi.kredit.index') }}" class="breadcrumb--active"> Kredit Donasi</a> </div>
                    <!-- END: Breadcrumb -->
