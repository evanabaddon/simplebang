...
@section('title' , 'Tambah Kredit Donasi')
@section('content')
<!-- BEGIN: Content -->
            <div class="content">
                <!-- BEGIN: Top Bar -->
               ...
               @endif
                ...
                <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-8">
                        <input type="text" name="judul" id="judul" class="intro-y input input--lg w-full box pr-10 placeholder-theme-13" placeholder="Judul Penggunaan Donasi">
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="intro-y box p-5">
                            ...
                            <div class="mt-3">
                                <label>Catatan</label>
                                <div class="mt-2">
                                    <textarea name="catatan" rows="8" cols="80" id="catatan" class="input w-full border mt-2" placeholder="Catatan penggunaan donasi, penjelasan secara singkat dan jelas"></textarea>
                                </div>
                            </div>
            ...
            <!-- END: Content -->
            <form class="hidden" id="form-kredit" action="{{ route('penggunaan-donasi.kredit.store') }}" method="post">
                @csrf
