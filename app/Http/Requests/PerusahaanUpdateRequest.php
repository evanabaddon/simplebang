...
class PerusahaanUpdateRequest extends FormRequest
{
     ...
     */
     ...
     {
         return [
             'id' => 'required|exists:perusahaan,id',
             'logo' => 'nullable|image|mimes:jpg,jpeg,png,gif,svg',
             'nama' => 'required|string|min:3|max:100|unique:perusahaan,nama,' . $this->id,
     ...
     public function messages(){
       return [
         'id.required' => 'Data perusahaan tidak ada.',
         'id.exists' => 'Data perusahaan tidak ada.',
