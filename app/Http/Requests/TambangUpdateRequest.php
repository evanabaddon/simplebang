...
class TambangUpdateRequest extends FormRequest
{
    /**
     ...
     */
     ...
     {
         return [
             'id'   => 'required|exists:tambang,id',
             'nama' => 'required|min:5|max:100|unique:tambang,nama,' . $this->id,
     ...
     public function messages(){
         return [
           'id.required' => 'Tambang tidak valid.',
           'id.exists' => 'Data tambang tidak ada.',
           ...
           'luas.max_digits' => 'Luas tambang harus diisi maksimal 100 karakter.',
